//put this in a web worker and put a loading screen on the 404
(async () => {
var keywords=window.location.pathname//.split('/')
...
outputHTML+="</ol>"
document.querySelector("p.jsonly").outerHTML="<p>Maybe this list will help?</p>"+outputHTML
})();