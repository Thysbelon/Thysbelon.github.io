...
if (navigator.userAgent.search("Edg") < navigator.userAgent.search("Chrome")) {
	...
	document.querySelector("#vibspeech img").outerHTML='<video disableremoteplayback autoplay muted loop playsinline title="I drew this using Shake Art DELUXE by nokoi"><source src="vib-min.webm" type="video/webm">An image of Vibri\'s head with a speech bubble.</video>'
}